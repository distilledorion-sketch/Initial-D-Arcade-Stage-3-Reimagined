...
- New runs require a matching detailed replay, current season and exactly game build `0.3.95-community-replays.29` (the ROM-required release). Older builds, future builds and alternate version strings cannot submit times.
