...
int main(int argc,char**argv){try{
 ...
 if(scene>=4){for(unsigned i=0;i<((scene==12||scene==13)?6u:((scene==14||scene==15)?2u:4u));++i){const unsigned dynamic=obj+0x8000+i*0x200;mem.write32(obj+0x4e4+i*4,dynamic);mem.write32(dynamic,obj+0x9000);}mem.write32(obj+0x9000+36,pathCountHook+4);cpu.callHooks[pathCountHook+4]=[&](RefCpu&){++excluded;};}
