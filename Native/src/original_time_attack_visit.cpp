...
bool valid(const OriginalTimeAttackVisit::Setup& s){return (s.condition<18||(s.condition<22&&!s.customCourseName.empty()&&!s.customMaps.empty()&&s.customMaps.size()<=5))&&s.weather<2&&s.car<35;}
