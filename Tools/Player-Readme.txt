...
Fixed phantom controls in autogenerated HID wheel/pedal layouts blocking rebinding. Escape, cancellation and timeout recover without leaving the menu disabled. Rain tire trails now follow the road slope and tire travel and remain fixed while fading.
Both online players need this version. Changed-file patches are provided from .20 through .27. Updates preserve personal saves, settings, replays, custom music and leaderboard times; only Delete Save removes a selected save.

FIXES INCLUDED FROM .27
