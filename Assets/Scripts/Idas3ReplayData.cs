...
public sealed class Idas3ReplayData
{
    ...
    public static readonly string[] Courses = { "Myogi", "Usui", "Akagi", "Akina", "Happogahara", "Irohazaka", "Shomaru", "Tsuchisaka", "Akina Snow", "Hakone", "Sadamine" };
    ...
    static Idas3ReplayData ParseInternal(byte[] data,bool opponentTrack)
    {
        ...
        if (metadata == null || metadata.condition < 0 || metadata.condition > 21 || metadata.car < 0 || metadata.car > 34 ||
