...
public static class Idas3OnlinePerfBuild
{
    public static void Build()
    {
        CheckCachedAdmission();
        const string output="Verification/multiplayer-performance-20260921/Player/InitialDUnity.exe";
    ...
    static void CheckCachedAdmission()
    {
        ...
        Directory.CreateDirectory("Verification/multiplayer-performance-20260921");
        File.WriteAllText("Verification/multiplayer-performance-20260921/admission-checks.txt","PASS "+checks+" cached admission checks without Steam initialized\n");
    }
}
